...
from django.core.mail import send_mail  #基于django内置的send_mail

from apps.users.models import EmailVerifyRecord  #邮箱验证码的数据库表
from Online.settings import EMAIL_FROM          #settings中配置的邮箱发送者
